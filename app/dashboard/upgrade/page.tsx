    ...
    return (
        ...
        <div className="py-24 sm:py-32">
            ...
            <div className="ring-2 ring-indigo-600 rounded-3xl p-8">
                ...
                <Button
            className="bg-indigo-600 w-full text-white shadow-sm hover:bg-indigo-500 mt-5 block rounded-md px-3 py-2 justify-center align-center text-center text-sm font-semibold leading-5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            Upgrade Now !!</Button>
                <ul
                role="list"
                className="mt-8 space-y-3 text-sm leading-6 text-gray-600"
